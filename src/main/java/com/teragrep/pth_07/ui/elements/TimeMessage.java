...
public class TimeMessage extends AbstractUserInterfaceElement {

    // TODO it is current unknown to u/1 for what is this used

    private final AngularObject<String> timeMsg;

    protected TimeMessage(InterpreterContext interpreterContext) {
        ...
        timeMsg = getInterpreterContext().getAngularObjectRegistry().add(
                "timeMsg",
                "",
        ...
        timeMsg.addWatcher(angularObjectWatcher);
    }
